...
static void gradio_gradio_app_real_activate (GApplication* base) {
	...
	app = _tmp0_;
	_tmp1_ = gradio_player_toolbar_new (&app);
	g_object_ref_sink (_tmp1_);
	_g_object_unref0 (self->player_toolbar);
	self->player_toolbar = _tmp1_;
	_tmp2_ = gradio_main_window_new (&app, &self->player_toolbar);
	g_object_ref_sink (_tmp2_);
	_g_object_unref0 (self->window);
	self->window = _tmp2_;
	_tmp3_ = audio_player_new ();
